---
title: fiber-test Documentation Index
doc_kind: project
doc_function: index
purpose: Корневая навигация по Memory Bank проекта fiber-test.
derived_from:
  - dna/principles.md
  - dna/governance.md
status: active
...
# fiber-test Memory Bank

Каталог `memory-bank/` хранит подтверждённый контекст, governance и delivery flows проекта `fiber-test`. Project-specific owners описывают default branch на commit `b88cbfd`; live-состояние и текущий product intent требуют подтверждения владельца.
