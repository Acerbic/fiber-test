...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [`UC-001`](UC-001-explore-scene.md) | Explore The 3D Scene | Visitor views the scene and receives octahedron interaction feedback | `active` | Browser visitor | `PRD-001` | none | 2026-09-07 |
